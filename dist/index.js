...
var FormWalletClient = class {
  ...
  getAddress() {
    var _a;
    return (_a = this.client.account) == null ? void 0 : _a.address;
  }
  getChain() {
    return this.chain;
  }
  ...
  async sendTransaction(transaction) {
    ...
    if (!abi2) {
      const txParams = {
        ...
        ...(options == null ? void 0 : options.gasLimit) && { gas: options.gasLimit },
        kzg: {}
      };
...
var formWalletProvider = {
  async get(runtime, _message, state) {
    try {
      ...
      const agentName = (state == null ? void 0 : state.agentName) || runtime.character.name || "The agent";
